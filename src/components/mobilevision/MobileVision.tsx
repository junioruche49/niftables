...
function MobileVision() {
  return (
    <div className="flex flex-col w-[95%] lg:my-52 my-10">
      <div className="w-full">
        <h3 className="monumentExtended text-2xl uppercase">
      ...
      <div className="flex">
        <div className="flex flex-col flex-cust-2 lg:pr-44 pr-20">
          <div className=" mt-10">
        ...
        <div className="flex flex-cust-12 items-end">
          <Image src={Vision} alt="vision" className="w-[20rem] h-[20rem]" />
        </div>
      </div>
    </div>
  );
...
export function SmMobileVision() {
  return (
