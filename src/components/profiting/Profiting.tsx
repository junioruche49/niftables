...
function Profiting() {
  return (
    <div className="flex flex-col">
      <h2 className="uppercase lg:text-6xl text-3xl text-white monumentExtended lg:mb-28">
        Profiting Through
      </h2>
      <div className="flex justify-end text-right lg:hidden mb-10">
        <h2 className="text-bg text-3xl  monumentExtended">
